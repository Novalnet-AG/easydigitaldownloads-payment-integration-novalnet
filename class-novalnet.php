 ...
 * Description: Plug-in to process payments in Easy Digital Downloads through Novalnet Gateway
 * Author:      Novalnet AG
	...
	final class Novalnet {
		...
		public static function instance() {
			...
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Novalnet ) ) {
				...
				add_action( 'plugins_loaded', array( self::$instance, 'novalnet_initialize_payments' ) );
