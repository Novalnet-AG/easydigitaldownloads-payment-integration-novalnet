...
Novalnet merchant account is required for processing all international and local payments through this Easy Digital Downloads payment plugin. The plugin is available for Wordpress versions 5.0 to 6.8.1, and Easy Digital Downloads versions 2.8.x to 3.3.8.1 in the following languages: EN & DE
...
For more information about the Easy Digital Downloads Payment Integration by Novalnet, please get in touch with us: <a href="mailto:sales@novalnet.de"> sales@novalnet.de </a> or +49 89 9230683-20<br>
