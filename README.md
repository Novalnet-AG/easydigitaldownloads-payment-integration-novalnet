...
Novalnet merchant account is required for processing all international and local payments through this Easy Digital Downloads payment plugin. The plugin is available for Wordpress versions 5.0 to 5.8.3, and Easy Digital Downloads versions 2.8.x to 2.11.4.1 in the following languages: EN & DE
