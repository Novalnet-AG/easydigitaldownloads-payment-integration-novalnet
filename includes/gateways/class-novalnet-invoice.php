...
class Novalnet_Invoice {
    ...
    public function novalnet_invoice_process_payment( $purchase_data ) {
        ...
        if ( isset( $edd_options['novalnet_invoice_guarantee_enable'] ) ) {
            novalnet_guarantee_payment_validation( $purchase_data, $payment_name );
        }
        
        // Guarantee requirement validations  
        if ( ( isset( $edd_options['novalnet_invoice_guarantee_enable'] ) && ! empty( EDD()->session->get( 'novalnet_invoice_guarantee_payment_error' ) ) && ! isset( $edd_options['novalnet_invoice_force_normal_payment'] ) ) ) {
        ...
        if ( isset( $edd_options['novalnet_invoice_guarantee_enable'] ) ) {
            ...
            if ( ! empty( $error ) && ! isset( $edd_options['novalnet_invoice_force_normal_payment'] ) ) {
        ...
        if ( isset( $edd_options['novalnet_invoice_guarantee_enable'] ) && empty( EDD()->session->get( 'novalnet_invoice_guarantee_payment_error' ) ) && empty( EDD()->session->get( 'novalnet_invoice_guarantee_dob_payment_error' ) ) ) {
        ...
        if ( 'authorize' === $edd_options['novalnet_invoice_manual_limit'] ) {
