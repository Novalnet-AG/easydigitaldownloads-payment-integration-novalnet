...
class Novalnet_Invoice {
    ...
    public function __construct() {
        ...
        if ( edd_is_gateway_active( 'novalnet_invoice' ) ) {
    ...
    public function novalnet_invoice_script_functions() {
        ...
        global $edd_options;
        // Enqueue script.
        wp_enqueue_script( 'edd-novalnet-invoice-script', NOVALNET_PLUGIN_URL . 'assets/js/novalnet.js', array( 'jquery' ), NOVALNET_VERSION, true );
    }
     ...
     */
    public function register_novalnet_invoice_settings( $gateway_settings ) {
