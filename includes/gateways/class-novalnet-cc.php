...
class Novalnet_Cc {
            ...
            <p>
                <label for="novalnet_cc_payment_desc">
                    <span class="edd-description" style="font-size:90%;">
                        <?php echo esc_html( __( 'The amount will be debited from your credit/debit card', 'edd-novalnet' ) ); ?>
                    </span>
                </label>
            </p>
            <p>
    ...
    public function novalnet_cc_process_payment( $purchase_data ) {
        ...
        if ( 'authorize' === $edd_options['novalnet_cc_manual_limit'] ) {
    ...
    public function register_novalnet_cc_settings( $gateway_settings ) {
        ...
        $novalnet_cc                     = array(
            ...
            array(
                'name' => '<strong><b><font size="2%" color="#000000">' . __( 'CSS settings for Credit Card iframe', 'edd-novalnet' ) . ' </font></b></strong>',
                'type' => 'header',
