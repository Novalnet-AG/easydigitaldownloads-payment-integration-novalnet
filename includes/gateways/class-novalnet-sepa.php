...
class Novalnet_SEPA {
    ...
    public function __construct() {
        ...
        if ( edd_is_gateway_active( 'novalnet_sepa' ) ) {
    ...
    public function novalnet_sepa_process_payment( $purchase_data ) {
        ...
        // Get payment data.
        $params       = $this->novalnet_get_sepa_bank_data();
        $payment_name = 'novalnet_sepa';
        ...
        if ( isset( $edd_options['novalnet_sepa_guarantee_enable'] ) && empty( EDD()->session->get( 'novalnet_sepa_guarantee_payment_error' ) ) && empty( EDD()->session->get( 'novalnet_sepa_guarantee_dob_payment_error' ) ) ) {
        ...
        if ( 'authorize' === $edd_options['novalnet_sepa_manual_limit'] ) {
     ...
     */
    public function novalnet_get_sepa_bank_data() {
        ...
        if ( ( isset( $edd_options['novalnet_sepa_guarantee_enable'] ) && ! empty( EDD()->session->get( 'novalnet_sepa_guarantee_payment_error' ) ) && ! isset( $edd_options['novalnet_sepa_force_normal_payment'] ) ) ) {
        ...
        if ( isset( $edd_options['novalnet_sepa_guarantee_enable'] ) ) {
            ...
            if ( ! empty( $error ) && ! isset( $edd_options['novalnet_sepa_force_normal_payment'] ) ) {
