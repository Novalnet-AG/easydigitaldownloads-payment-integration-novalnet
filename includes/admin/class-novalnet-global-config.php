    ...
    public function register_novalnet_global_settings( $gateway_settings ) {
        ...
        $novalnet_global = array(
            ...
            array(
                ...
                /* translators: %s: admin URL */               
                'desc'              => '<br/>' . sprintf( __( "Get your Product activation key from the <a href='%s' target='blank'>Novalnet Admin Portal</a>: PROJECT > Choose your project > Shop Parameters > API Signature (Product activation key)","edd-novalnet"), $admin_url ),
            ),
            array(
