...
function update_transaction_details( $response, $payment_gateway ) {
    ...
    update_post_meta( $response['order_no'], '_nn_customer_id', $edd_options['novalnet_product_id'] . '-' . $customer_id );
    ...
    $wpdb->insert(
        ...
        array(
            ...
            'payment_id'      => ( isset( $response['key'] ) && !empty( $response['key'] ) ) ? $response['key'] : !empty($response['payment_id']) ? $response['payment_id']  :'',
